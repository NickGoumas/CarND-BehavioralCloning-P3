...
# NVIDIA end-to-end convolutional neural network. Images are normalized 
...
for batch_size in [512, 256, 128, 64]:
    for learn_rate in [0.00005]:
        for drop_out in [0.00, 0.25, 0.50]:
            ...
            early_stop = EarlyStopping(monitor='val_loss', min_delta=0.00001, patience=2000, verbose=0, mode='auto')
